...
pub fn analyse_space_complexity_for_constant_set_algorithm(passes_info:  &ConstantSetAlgorithmPassesInfo,
    ...
    // max mem used
    let s1 = (measurements.pass_1_measurements.max_used_memory as f64 - measurements.pass_1_measurements.used_memory_before as f64) / passes_info.repetitions as f64;
    let s2 = (measurements.pass_2_measurements.max_used_memory as f64 - measurements.pass_2_measurements.used_memory_before as f64) / passes_info.repetitions as f64;
